...
<head>
    ...
    <title>تعديل سياسة الاسترجاع</title>
</head>
<body>
          ...
          <div class="navbar-collapse collapse" id="navbarBasic" style="">
            <ul class="navbar-nav ms-auto mb-2 mb-xl-0">
              ...
              <li class="nav-item active">
                <a class="nav-link" aria-current="page" href="{{route('return.data.view')}}">سياسة الاسترجاع</a>
              </li>
              <li class="nav-item">
    ...
    <h3 class="mt-3 text-center">تعديل سياسة الاسترجاع</h3>
    ...
    @endif
    <div class="main p-4">
        <form action="{{route('return.data.update',$return->id)}}" class="w-100 m-auto">
            @error('content')
              <p class="alert alert-danger">{{$message}}</p>
            @enderror
            <div class="row">
                <h5>السياسة الاسترجاع</h5>
                <label for="returnData">بيانات صفحة سياسة الاسترجاع</label>
                <textarea id="returnData" name="content">{{old('content',$return->content)}}</textarea>
