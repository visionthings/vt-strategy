...
<body>
          ...
          <div class="navbar-collapse collapse" id="navbarBasic" style="">
            <ul class="navbar-nav ms-auto mb-2 mb-xl-0">
              ...
              <li class="nav-item active">
                <a class="nav-link" aria-current="page" href="{{route('terms.data.view')}}">الشروط والاحكام</a>
              </li>
              <li class="nav-item">
    ...
    <h3 class="mt-3 text-center">تعديل الشروط والأحكام</h3>
    ...
    @endif
    <div class="main p-4">
        <form action="{{route('terms.data.update',$term->id)}}" class="w-100 m-auto">
            @error('content')
              <p class="alert alert-danger">{{$message}}</p>
            @enderror
            <div class="row">
              <h5>الشروط والاحكام</h5>
              <label for="termsData">بيانات صفحة الشروط والأحكام</label>
              <textarea id="termsData" name="content">{{old('content',$term->content)}}</textarea>
